        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
                ...
                <div class="card-body mt-3">
                    <div class="row">
                        <div class="col-auto">
                            <input type="text" class="form-control form-control-sm" placeholder="Cari berdasarkan username dan area" id="cari">
                        </div>
                        <div class="col-md-12">
                ...
                <div class="card-footer mt-3">
                    <button type="button" class="btn btn-primary btn-sm" id="addVisitor">Tambah</button>
...
<script type="text/javascript">
    ...
    $('#addVisitor').on('click', function() {
        ...
        $.ajax({
            url: '../components/ict/formVisitor.php',
            type: 'get',
            data: {user:user},
