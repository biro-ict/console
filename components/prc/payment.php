        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
                <div class="card-header bg-primary">
                    <h4 class="text-title text-white">Data Termin Pembayaran</h4>
                </div>
...
<script type="text/javascript">
    ...
    $('#deletePaymentterm').on('click', function() {
        ...
        if(totals == 0) {
            ...
            $('#tbl-payment input[type=checkbox]:checked').each(function() {
                var row = $(this).val()
                array.push(row) 
            })
            ...
            Swal.fire({
                ...
                if(result.isConfirmed) {
                    $.ajax({
                        url: url_api + '/paymentterm/delete',
                        type: 'post',
                        data: {
                            id: array, 
                            updatedby: users,
            ...
            success: function(res) {
                if(res.status == 'success') {
                    ...
                    data.forEach(function(items, index) {
                        tb = tb + `<tr>
                             <td class="col-1"><input type="checkbox" class="form-check-input  checked" value="${items.paymenttermid}"> </td>
