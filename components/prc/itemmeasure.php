        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
                <div class="card-header bg-primary">
                    <h4 class="text-title text-white">Data Satuan Item</h4>
                </div>
...
<script type="text/javascript">
    ...
    $('#addItemmeasure').on('click', function() {
        ...
        if(totals == 0) {
            ...
            Swal.fire({
                ...
                if(result.isConfirmed) {
                    $.ajax({
                        url: url_api + '/itemmeasure/delete',
                        type: 'post',
                        data: {
                            id: array, 
                            updatedby: users,
            ...
            success: function(res) {
                if(res.status == 'success') {
                    ...
                    data.forEach(function(items, index) {
                        tb = tb + `<tr>
                             <td class="col-1"><input type="checkbox" class="form-check-input  checked" value="${items.itemmeasureid}"> </td>
