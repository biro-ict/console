        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
                ...
                <div class="card-footer mt-3">
                    <button type="button" class="btn btn-sm btn-success" id="formBranch">Ubah</button>
...
<script>
    ...
    $('#formBranch').on('click', function() {
        var formdata = new FormData()
        var id = `<?php echo $id;?>`;

        var url = id == 0 ? '/branch/add' : '/branch/update'


        Swal.fire({
            title: 'Kamu yakin?',
            text: 'Data Cabang akan diubah',
            icon: 'warning',
