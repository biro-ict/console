...
>
  ...
  <body>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.php" class="app-brand-link">       
              <span class="app-brand-text demo menu-text fw-bolder ms-2">BBG HUB</span>
            </a>
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                ...
                <ul class="navbar-nav flex-row align-items-center ms-auto">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" id="logout_apps">
    ...
    <script>
      $('#logout_apps').on('click', function() {
        $.ajax({
          url: '../config/auth.php?f=logout',
          type: 'get',
          success: function(res) {
            if(res.status == 'success') location.href = 'index.php'
          }
        })
      })
      ...
      $(document).ready(function(){
        ...
        $.ajax({
          url : '../components/home/topcard.php',
          type: 'get',
          data: {
            user : user
          },
